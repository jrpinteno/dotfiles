...
clone_dotfiles() {
	...
	git -C "$dotfiles_directory" remote set-url origin "git@github.com:jrpinteno.me/dotfiles.git" || {
		print_message "$RED" "Failed to update Git remote URL."
	}
...
create_config_symlinks() {
	...
	create_symlink "$HOME/dotfiles/nvim" "$XDG_CONFIG_HOME/nvim" "NeoVim"
}
